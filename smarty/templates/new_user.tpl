...
<!--[if $debug]--><span style="color:red;"><!--[$smarty.template]--></span><!--[/if]-->    <div class="callout panel" style="margin-top: 20px;">
    ...
    <div class="panel callout">
        <h3><!--[$static_content.label3|escape]--></h3>
        <p><!--[$static_content.label4|escape]--> <!--[$this_user.user_firstname|escape]--> <!--[$this_user.user_lastname|escape]--> - <!--[$static_content.label5|escape]--> <!--[$this_user.user_tel|escape]--> - <!--[$static_content.label6|escape]--> <!--[$this_user.user_email|escape]--></p>
        <h4><!--[$static_content.label7|escape]--></h4>
    </div>
