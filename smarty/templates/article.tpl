...
<div class="large-8 medium-10 small-12 columns" style="margin-top: 20px; /* for allowing space below navigation bar */">
    ...
    <a href="<!--[if $ispreview]-->/preview-pub-<!--[else]-->/read-<!--[/if]--><!--[$this_pub.pub_slug|escape]-->/issue-<!--[$this_pub.pub_issue|escape]-->">
        ...
        <p class="pub_banner"><!--[$static_content.issue|escape]--> <!--[$this_pub.pub_issue|escape]--> - <!--[$this_pub.pub_issue_tstamp|date_format:"%A, %B %e, %Y"|escape]--></p>
    </a>      
    </div>
    ...
    <div class="panel">
        <h2><!--[$this_content.article_title|escape]--></h2><h5><!--[$this_content.article_subtitle|escape]--></h5>
            <!--[if $this_content.article_source]--><p><!--[$static_content.source|escape]--> <!--[$this_content.article_source|escape]--></p><!--[/if]-->
    </div>
    <div id="panel<!--[$this_content.article_id]-->b" class="content" data-slug="panel<!--[$this_content.article_id]-->b">
      ...
      <!--[/if]-->
      <!--[if $this_content.article_source]--><p><a href="/check-source-<!--[$this_content.article_pub_issue_id|escape]-->/article-<!--[$this_content.article_id|escape]-->" target="_blank"><!--[$static_content.source|escape]--> <!--[$this_content.article_source|escape]--></a></p><!--[/if]-->
      <!--[p_tag_this string=$this_content.article_body|escape article=$this_content.article_id|escape]-->
      <!--[if $user_publications]--><a href="#" class="button tiny"><!--[$static_content.demimot_button|escape]--></a><!--[/if]-->
    </div>
</div>