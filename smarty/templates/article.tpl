<div class="large-8 medium-10 small-12 columns" style="margin-top: 40px; /* for allowing space below navigation bar */">
   ...
   <!-- <pre> <!--$this_content|@var_dump-->  <!--</pre>-->
            ...
            <div class="panel">
              ...
              <!--[if $this_content.article_source]-->source: <!--[$this_content.article_source|escape]--><!--[/if]-->
            </div>
            <div id="panel<!--[$this_content.article_id]-->b" class="content" data-slug="panel<!--[$this_content.article_id]-->b">
              ...
              <!--[/if]-->
              <!--[if $this_content.article_source]--><p><a href="?piid=<!--[$this_content.article_pub_issue_id|escape]-->" target="_blank">source: <!--[$this_content.article_source|escape]--></a></p><!--[/if]-->
              <!--[p_tag_this string=$this_content.article_body|escape article=$this_content.article_id|escape]--><!--[$teste]-->
            </div>
