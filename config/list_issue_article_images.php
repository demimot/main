<?php 
     ...
     */
    $aColumns = array('issue_article_image_id', 'article_image_filename', 'article_image_caption', 'article_image_credits');
     
    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "issue_article_image_id";
    ...
    {
        $row .= '<option value="' . htmlspecialchars($aRow['issue_article_image_id']) . '" data-caption="' . htmlspecialchars($aRow['article_image_caption']) . '" data-copyright="' . htmlspecialchars($aRow['article_image_credits']) . '">' . htmlspecialchars($aRow['article_image_filename']) . '</option>';
	}
